...
TYPE = "logic"
SUFFIX = "inst"
VAR_BASE_NAME = "expand_left_operand"
...
def reduce_bracket(match):
    ...
    ret_lines.append("  assign {} = {} {} {};".format(assignment_destination, var_name_with_suffix, operator, right_side))
